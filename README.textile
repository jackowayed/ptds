...
where <pre><code>code.gpy</code></pre> is the file. --flags --for --python will get passed to python. 
...
Where <pre><code>code.py</code></pre> is the destination file. You may also use -c instead of --compile. 
